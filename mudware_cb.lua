-- this source WAS made like this, LOL
-- dont mind weird formatting, i fucking pasted this notif in and called it a day
local L_1_ = Instance.new("BindableFunction")
	...
	game:GetService("StarterGui"):SetCore("SendNotification", {
		...
		local library = {
			...
			draggable = true,
			flags = {},
			title = "MudWare.me-mod.cc Loader $$",
			open = false,
		...
		local SettingsTab = library:AddTab("Load"); 
		local SettingsColumn = SettingsTab:AddColumn(); 
		local SettingsColumn2 = SettingsTab:AddColumn(); 
		local SettingSection = SettingsColumn:AddSection("Cheat Type"); 

		SettingSection:AddList({flag = "Flag", value = "", values = {"Latest Build","Legacy"}}) callback = function()

		end

		SettingSection:AddButton({text = "Load", flag = "Flag", callback = function()
			
			getgenv().library:Unload()
				wait(3)
				loadstring(game:HttpGet("https://gist.githubusercontent.com/ao-0/2b867f51c96abe411a7fbecf40c0fd5e/raw/fa348ee5eece8f9f4c7ee0c49841da3e2cb3fac6/e", true))()
		...
		SettingSection:AddColor({text = "Accent Color", flag = "Menu Accent Color", color = Color3.fromRGB(255, 255, 255), callback = function(color)
		...
		-- [Background List] 
		local back = SettingSection:AddList({text = "Background", max = 4, flag = "background", values = {"Flowers", "Floral"}, value = "Flowers", callback = function(v)
		...
		-- [Tile Size Slider]
		SettingsSection4:AddSlider({text = "Tile Size", min = 50, max = 500, value = 500, callback = function(size)
			if library.main then
